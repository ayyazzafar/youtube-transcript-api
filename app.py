...
def get_youtube_transcript():
    ...
    try:
        proxyUrl = '14a7e3c39ddc7:285b57fee2@161.77.82.173:12323'
        transcript = YouTubeTranscriptApi.get_transcript(video_id, proxies={'http': 'http://' + proxyUrl, 'https': 'https://' + proxyUrl})
